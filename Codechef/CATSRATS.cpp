  ...
  while (T--) {
    ...
    for (int i = 0; i < M; i++) {
      ...
      for (int j = 0; j < N; j++) {
        ...
        int rat_t_start = ri[i],
            rat_t_end = rat_t_start + abs(rat_end - rat_start);
        ...
        // cout << "catdir" << catdir << '\n';
        // cout << "dir" << dir << '\n';
        // cout << "rat: " << rat_start << ' ' << rat_end << ' ' << rat_t_start
        // << ' ' << rat_t_end << '\n'; cout << "cat: " << cat_start << ' ' <<
        // cat_end << ' ' << cat_t_start << ' ' << cat_t_end << '\n';
        ...
        if (rel == 0) {
          ...
          if (max(cat_t_start, rat_t_start) + time <= cat_t_end &&
              max(cat_t_start, rat_t_start) + time <= rat_t_end) {
